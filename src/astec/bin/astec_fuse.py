...
import astec.algorithms.fusion as fusion
...
def main():
    ...
    if args.printParameters:
        ...
        experiment.print_parameters(directories=["rawdata", "fusion"])
    ...
    experiment.write_parameters(
        monitoring.log_filename, directories=["rawdata", "fusion"]
    )
    ...
    # processing
    #
    fusion.fusion_control(experiment, parameters)
