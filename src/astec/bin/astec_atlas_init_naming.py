...
import astec.algorithms.atlas_init_naming as aatlasin
...
def main():
    ...
    if args.printParameters:
        parameters = aatlasin.InitNamingParameters()
    ...
    # so the log filename is known
    #
    aatlasin.monitoring.copy(monitoring)
    ...
    prop = aatlasin.init_naming_process(experiment, parameters)
