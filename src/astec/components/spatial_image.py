...
class SpatialImage(np.ndarray):
    ...
    def __new__(
        ...
        if voxelsize is None:
            ...
            try:
                voxelsize = input_array.voxelsize
            except:
                voxelsize = (1.0,) * input_array.ndim
        else:
            # Jonathan _ Compatibility with "champs_*.inr.gz" generated by Baloo & SuperBaloo
            if (input_array.ndim != 4) and (len(voxelsize) != input_array.ndim):
    ...
    voxelsize = property(get_voxelsize, set_voxelsize)
...
def empty_image_like(spatial_image):
    ...
    return SpatialImage(array, spatial_image._voxelsize, vdim=1)
